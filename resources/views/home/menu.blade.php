...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
    ...
    <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
        <div class="navbar-nav mr-auto py-0">
            ...
            <a href="category.html" class="nav-item nav-link">Benefícios</a>
            <a href="single.html" class="nav-item nav-link">Como Chegar</a>
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu rounded-0 m-0">
                    ...
                    <a href="#" class="dropdown-item">Estabelecimentos</a>
                </div>
            </div>
            <div class="nav-item dropdown">
            ...
            <a href="contact.html" class="nav-item nav-link">História</a>
