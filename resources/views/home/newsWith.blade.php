                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                ...
                                <a class="text-secondary font-weight-medium text-decoration-none" href="">Ver Tudo</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="{{URL::asset('img/news-700x435-1.jpg')}}" style="object-fit: cover;">
                                ...
                                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                    <div class="d-flex align-items-center">
                                        <img class="rounded-circle mr-2" src="{{URL::asset('img/user.jpg')}}" width="25" height="25" alt="">
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="{{URL::asset('img/news-700x435-2.jpg')}}" style="object-fit: cover;">
                                <div class="bg-white border border-top-0 p-4">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                            href="">Business</a>
                ...
                <div class="col-lg-4">
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <a href=""><img class="img-fluid" src="{{URL::asset('img/news-800x500-2.jpg')}}" alt=""></a>
                        </div>
                    </div> -->
                    <!-- Ads End -->
