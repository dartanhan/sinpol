    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Cadastrar Benefício</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-primary text-white py-3 d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 p-0 text-white text-uppercase">
                            <i class="bi bi-plus-circle me-2"></i>Cadastrar Benefício
                        </h5>
                        ...
                        <form method="POST" action="{{route('beneficio.store')}}" name="beneficioForm" id="beneficioForm" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="titulo" id="titulo" class="form-control" placeholder="Nome do benefício" maxlength="150" required value="{{ old('titulo') }}">
