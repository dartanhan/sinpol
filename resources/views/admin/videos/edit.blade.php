            ...
            <div class="col-lg-12">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{route('video.update', $video->id)}}" name="videoForm" id="videoForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 text-start">
                                    ...
                                    <input type="text" name="titulo" id="titulo" class="form-control"
                                        placeholder="Título descritivo" required
                                ...
                                <div class="col-md-6 text-start">
                                    ...
                                    <input type="text" name="slug" id="slug" readonly class="form-control bg-light"
                                        placeholder="Gerado automaticamente" value="{{ old('slug', $video->slug) }}">
                                </div>
                                ...
                                <div class="col-md-12 text-start">
                                    ...
                                    <textarea name="subtitulo" id="subtitulo" class="form-control" rows="3"
                                        placeholder="Breve descrição ou resumo sobre o conteúdo do vídeo">{{ old('subtitulo', $video->subtitulo) }}</textarea>
                                </div>

                                <x-status-select :status="$video->status" />
                            </div>
